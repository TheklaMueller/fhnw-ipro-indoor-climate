...
- [ ] Send an email or push notification when CO₂ levels exceed a set threshold
- [ ] Over-the-Air (OTA) updates for firmware changes without USB
- [ ] Use NTP (Network Time Protocol) to include accurate timestamps in your records
- [ ] Send data only over HTTPS, use API tokens, and explain the importance of authentication
- [ ] Buffer measurements when Wi-Fi is unavailable and send them later
